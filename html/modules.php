...
function modChrome_well($module, &$params, &$attribs)
{
	if ($module->content) {
		if($params->get('bootstrap_size')) {
			echo "<div class=\"col-sm-" . htmlspecialchars($params->get('bootstrap_size')) . "\">";
		}
...
function modChrome_standard($module, &$params, &$attribs)
{
	if ($module->content) {
		if($params->get('bootstrap_size')) {
			$bootstrap = " col-sm-" . htmlspecialchars($params->get('bootstrap_size'));
		}
		echo "<div class=\"module " . htmlspecialchars($params->get('moduleclass_sfx')) . $bootstrap . "\">";
		if ($module->showtitle)
		{
